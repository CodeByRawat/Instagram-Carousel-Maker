...
function buildDadlySystemPrompt() {
  return [
    ...
    "",
    "ABOUT DADLY: An app for new and expecting dads. Gives clear, calm answers to pregnancy, newborn, and early parenting questions — no panic spirals.",
    "",
    "VOICE:",
    "- Direct, practical, reassuring. Man-to-man tone.",
    "- No fluff. No judgment. No baby-talk.",
    "- The hook slide MUST make a dad stop mid-scroll — use a question they're too scared to Google, a 3am panic moment, or a bold fact they've never heard.",
    "",
    "FORMAT FOR QUESTION CAROUSELS:",
    "- Each lesson slide = one viral question dads actually ask + a clear, calm answer.",
    "- The question IS the headline. Make it feel like the dad is thinking it himself.",
    "- The body = the answer. Short, factual, reassuring. No waffle.",
    "- Good question angles: 'Is it normal if...', 'Why does my baby...', 'Should I worry about...', 'When will my baby...', 'What does it mean when...'",
    "",
    "RULES:",
    "- Only factually accurate parenting/baby information.",
    "- Use exactly 6 slides: hook, question, question, question, question, CTA.",
    "- The CTA always promotes downloading the Dadly app.",
    "- NEVER use em dashes (—). Use a comma, colon, or plain hyphen instead.",
    "",
    "FORMAT: Output MUST be valid JSON only. No markdown. No backticks.",
  ].join("\n")
}
...
function buildDadlyUserPrompt({ theme, language }) {
  return [
    ...
    "    {",
    '      "type": "lesson",',
    '      "lessonLabel": "Q 01 · [topic in caps]",',
    '      "ghostNumber": "01",',
    '      "headline": string,',
    '      "body": string,',
    '      "handle": "pagefordads"',
    ...
    "    {",
    '      "type": "lesson",',
    '      "lessonLabel": "Q 02 · [topic in caps]",',
    '      "ghostNumber": "02",',
    '      "headline": string,',
    '      "body": string,',
    '      "handle": "pagefordads"',
    ...
    "    {",
    '      "type": "lesson",',
    '      "lessonLabel": "Q 03 · [topic in caps]",',
    '      "ghostNumber": "03",',
    '      "headline": string,',
    '      "body": string,',
    '      "handle": "pagefordads"',
    ...
    "    {",
    '      "type": "lesson",',
    '      "lessonLabel": "Q 04 · [topic in caps]",',
    '      "ghostNumber": "04",',
    '      "headline": string,',
    '      "body": string,',
    '      "handle": "pagefordads"',
    ...
    "",
    "Content rules:",
    "- Hook headline: 2–4 short stacked lines. The kind of thing dads whisper at 3am. Use *asterisks* around the most relatable word or phrase.",
    "- Hook subtext: one line — tease that the answers are inside.",
    "- Lesson lessonLabel: 'Q 01 · TOPIC' — topic is 1–3 words in caps (e.g. 'Q 01 · CRYING', 'Q 02 · SLEEP', 'Q 03 · POOP COLOR').",
    "- Lesson headline: the viral question itself, max 10 words. Conversational. Use *asterisks* on the scariest or most relatable word.",
    "- Lesson body: 2–3 sentences answering the question. Calm, factual, specific. Bold the single most important fact with **double asterisks**.",
    "- Pick questions that are genuinely common dad anxieties — the ones they Google at 2am but feel embarrassed to ask the doctor.",
    "- CTA pillars: 5 Dadly app features that directly solve the fears raised in the carousel.",
  ].join("\n")
}
